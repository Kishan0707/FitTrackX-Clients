...
const DoctorAppointments = () => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      pending: { bg: "bg-yellow-500/20", text: "text-yellow-400", icon: <MdPending /> },
      confirmed: { bg: "bg-blue-500/20", text: "text-blue-400", icon: <FaCheck /> },
      completed: { bg: "bg-green-500/20", text: "text-green-400", icon: <FaCheck /> },
      cancelled: { bg: "bg-red-500/20", text: "text-red-400", icon: <MdCancel /> },
      "in-progress": { bg: "bg-orange-500/20", text: "text-orange-400", icon: <FaClock /> },
    };
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-white">{appointments.length}</p>
              </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[800px]">
                <thead className="border-b border-slate-800 bg-slate-800/50">
                  <tr>
                    <th className="p-4 text-left text-sm font-semibold text-slate-300">Patient</th>
                    ...
                    <th className="p-4 text-left text-sm font-semibold text-slate-300">Mode</th>
